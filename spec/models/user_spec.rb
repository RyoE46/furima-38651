...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'passwordに半角英数字混合でないと登録できない' do
        @user.password = 'hatebreed'
        @user.valid?
        expect(@user.errors.full_messages).to include('Password is invalid')
      end
      it 'passwordの値が同じでなければ登録できない' do
        @user.password = 'HeteBreed2002'
        @user.password_confirmation = 'HeteBreed2012'
        @user.valid?
